                ...
                <div className="space-y-6">
                    ...
                    <div id="discourse-content" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-inner min-h-[400px] text-gray-800 dark:text-gray-100">
                        <div className="prose prose-indigo dark:prose-invert max-w-none">
                            <ReactMarkdown
                                components={{
                                    h1: ({ node, ...props }) => <h1 className="text-3xl font-black text-indigo-700 dark:text-indigo-400 mb-6 border-b-2 border-slate-200 dark:border-slate-800 pb-2" {...props} />,
                                    h2: ({ node, ...props }) => <h2 className="text-2xl font-bold text-indigo-600 dark:text-indigo-300 mt-8 mb-4 border-b border-slate-200 dark:border-slate-800 pb-1" {...props} />,
                                    h3: ({ node, ...props }) => <h3 className="text-xl font-bold text-indigo-600 dark:text-indigo-400 mt-6 mb-3" {...props} />,
                                    h4: ({ node, ...props }) => <h4 className="text-lg font-semibold text-indigo-500 dark:text-indigo-300 mt-4 mb-2" {...props} />,
                                    p: ({ node, ...props }) => <p className="text-gray-800 dark:text-gray-100 leading-relaxed text-lg mb-4" {...props} />,
                                    strong: ({ node, ...props }) => <strong className="text-indigo-900 dark:text-white font-bold bg-indigo-50 dark:bg-indigo-900/50 px-1 rounded" {...props} />,
                                    ul: ({ node, ...props }) => <ul className="list-disc pl-5 space-y-2 text-gray-800 dark:text-gray-100 mb-4" {...props} />,
                                    ol: ({ node, ...props }) => <ol className="list-decimal pl-5 space-y-2 text-gray-800 dark:text-gray-100 mb-4" {...props} />,
                                    li: ({ node, ...props }) => <li className="pl-1" {...props} />,
                                    blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-indigo-500 pl-4 py-2 my-4 bg-indigo-50 dark:bg-slate-800/50 text-indigo-800 dark:text-indigo-200 italic rounded-r-lg" {...props} />,
                                }}
                            >
