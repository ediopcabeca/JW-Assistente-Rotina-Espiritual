      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-indigo-100 text-sm">
                   {hasStartDateSet(userId) ? `Dia ${dailyReading.planDay} (Estimado)` : 'Plano de Leitura'}
                </div>
              </div>
            </div>
        ...
        <div className="p-6 border-b border-gray-100 dark:border-gray-700">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            <div>
              <h3 className="text-sm font-semibold text-gray-500 uppercase flex items-center gap-2"><Sparkles size={16} /> Próxima Leitura</h3>
              <p className="text-2xl font-bold text-gray-800 dark:text-white mt-1">{dailyReading.text || "Leitura em dia!"}</p>
            </div>
